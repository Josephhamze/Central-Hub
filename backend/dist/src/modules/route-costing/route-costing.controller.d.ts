...
export declare class RouteCostingController {
    private readonly routeCostingService;
    constructor(routeCostingService: RouteCostingService);
    ...
    findOne(id: string): Promise<{
        ...
        scenarios: ({
            ...
            tripsPerMonth: import("@prisma/client/runtime/library").Decimal | null;
            plannedTonnagePerMonth: import("@prisma/client/runtime/library").Decimal | null;
        })[];
    } & {
        id: string;
        name: string;
...
export declare class CostingCalculatorController {
    private readonly routeCostingService;
    constructor(routeCostingService: RouteCostingService);
    calculate(dto: CalculateCostingDto): Promise<{
        distanceKm: string;
