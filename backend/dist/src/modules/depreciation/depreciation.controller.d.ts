...
export declare class DepreciationController {
    ...
    runMonthly(dto: RunMonthlyDepreciationDto, userId: string): Promise<{
        period: string;
    ...
    postEntry(assetId: string, period: string, userId: string): Promise<{
        id: string;
        createdAt: Date;
        period: string;
        assetId: string;
    ...
    postAllForPeriod(period: string, userId: string): Promise<{
        period: string;
        total: number;
        posted: number;
        failed: number;
