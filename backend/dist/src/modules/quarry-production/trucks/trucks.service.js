...
let TrucksService = class TrucksService {
    ...
    async create(dto) {
        ...
        if (existing) {
            throw new common_1.BadRequestException('Truck with this name already exists');
        }
    ...
    async remove(id) {
        ...
        if (entryCount > 0) {
            throw new common_1.BadRequestException(`Cannot delete truck with ${entryCount} associated entries. Please deactivate it instead.`);
        }
