...
export function ExcavatorEntriesPage() {
  ...
  const canCreate = hasPermission('quarry:excavator:create');
  const canUpdate = hasPermission('quarry:excavator:update');
  const canDelete = hasPermission('quarry:excavator:delete');
  const canApprove = hasPermission('quarry:excavator:approve');
